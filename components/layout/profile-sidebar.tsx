...
import { NavItem, SidebarNavItem } from "@/global.d";
...
export function ProfileSidebar({ links }: ProfileSidebarProps) {
...
export function MobileSheetSidebar({ links }: ProfileSidebarProps) {
    const path = usePathname();
