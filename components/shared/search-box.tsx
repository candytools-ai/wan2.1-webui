    ...
    <div className="flex flex-col">
      <div className="w-full mx-auto mb-4">
        <div className="relative flex items-center space-x-2">
          <div className="relative w-full max-w-3xl flex items-center mx-auto">
            ...
            <Input
              ...
              className={
                "text-base w-full pl-12 pr-4 py-5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:focus:ring-blue-500"
              }
              placeholder="Search..."
            />
            {q.length > 0 ? (
